<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucThamSoDS.ascx.cs" Inherits="Presentation.WebClient.Modules.QTHT.ThamSo.ucThamSoDS" %>
...
<script language="javascript" type="text/javascript">
    var griddataid = '<%=grdThamSoDS.ClientID %>'
    var oTable;
...
<table class="CsTable">   
    <tr>
        <td style="width: 25%;" valign="top">   
            <asp:Panel ID="pnTree" runat="server" GroupingText="Loại tham số" CssClass="TitlePanel">                 
                  <asp:TreeView ID="tvwTree" runat="server" OnLoad="tvwTree_Load" OnSelectedNodeChanged="tvwTree_SelectedNodeChanged"></asp:TreeView>
            </asp:Panel>          
        </td>
        <td valign="top">        
            <asp:Panel ID="pnDanhSachThamSo" runat="server" GroupingText="Danh sách tham số" CssClass="TitlePanel"> 
                <div class="scroll-pane" id="divtableContent" style="min-height:200px"> 
                        <asp:DataGrid runat="server" ID="grdThamSoDS" AutoGenerateColumns="false"
                                        BorderColor="#D9D9D9" CellPadding="4" 
                                        AlternatingItemStyle-BackColor="#F1F1F2"
                                        BackColor="White" Width="1200px" BorderWidth="1px" 
                                onitemdatabound="grdThamSoDS_ItemDataBound" CssClass="display">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn>
                                                ...
                                                <ItemTemplate>
                                                 <%#DataBinder.Eval(Container.DataItem, "TEN_THAM_SO")%>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                             <asp:TemplateColumn >
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                            ...
                                            <asp:TemplateColumn>
                                                ...
                                                <ItemTemplate>
                                                 <%#DataBinder.Eval(Container.DataItem, "GIA_TRI")%>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn>
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
