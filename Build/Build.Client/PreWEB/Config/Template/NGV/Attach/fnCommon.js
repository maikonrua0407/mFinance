...
function openPopUpWindow(url, targetField, wt, ht) {
    centeredY = window.screenY + (((window.outerHeight / 2) - (ht / 2))) - 30;
    centeredX = window.screenX + (((window.outerWidth / 2) - (wt / 2)));
    var w = window.open(url, '_blank', 'width=' + wt + ',height=' + ht + ',scrollbars=1,left=' + centeredX + ',top=' + centeredY);
...
function resizeElementHeight(element) {
    ...
    getObj(element).style.height = ((height ) + "px");
}
