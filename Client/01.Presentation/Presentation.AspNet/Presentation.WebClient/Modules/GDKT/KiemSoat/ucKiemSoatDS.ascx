...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $("#" + griddataid).DataTable({
            "columnDefs": [
            {
                "targets": [ 3 ],
                "visible": false
        ...
        $("#btnEdit").on("click", function () {
            ...
            for (j = 0; j < scb.length; j++) {
                if (getObj(scb[j].id).checked == true) {
                    ...
                    url=table.cells({ row: j, column: 3 }).data()[0];
                    break;
                }
            }
            ...
            if (IDGiaodich != 0) {
                if (url.length>0)
                {
                    showpopup(url + "&ID=" + IDGiaodich + "&t=2", window.outerWidth - 120, window.outerHeight - 100)
                }
            }
        });
        ...
        $("#btnView").on("click", function () {
            ...
            if (IDGiaodich != 0) {
                if (url.length>0)
                {
                    showpopup(url + "&ID=" + IDGiaodich + "&t=1", window.outerWidth - 120, window.outerHeight - 100)
                }
            }
        });
        ...
        $("#<%=teldtNgayGDTu.ClientID%>").datepicker({ dateFormat: 'dd/mm/yy' });
        $("#<%=teldtNgayGDDen.ClientID%>").datepicker({ dateFormat: 'dd/mm/yy' });
                    ...
                    <td valign="top">
                        <div style="overflow:auto; width:260px;height:550px">
                            <asp:TreeView ID="tvwLoaiGD" ShowLines="true" runat="server" 
                                ...
                                <SelectedNodeStyle CssClass="red bold" />
                            </asp:TreeView>
                         </div>
                    </td>
                </tr>
                ...
                <asp:DataGrid runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container.DataItem, "TRANG_THAI_DT")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
                            <HeaderStyle HorizontalAlign="Center" ></HeaderStyle>
