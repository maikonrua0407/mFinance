                    ...
                    if (null != v_ctlContainer)
                    {
                        ...
                        if ((null != v_ctlModule) && (v_ctlModule is ControlBase))
                        {
                            ...
                            if (pv_strRightList.IndexOf("FullControl") >= 0)
                            {
                                ...
                                ((ControlBase)v_ctlModule).CanApprove = true;
                            }
                            else
                            {
                                ...
                                if (pv_strRightList.IndexOf("Approve") >= 0)
                                {
                                    ((ControlBase)v_ctlModule).CanApprove = true;
                                }
                                if (pv_strRightList.IndexOf("UnApprove") >= 0)
                                {
                                    ((ControlBase)v_ctlModule).CanUnApprove = true;
                                }
                                if (pv_strRightList.IndexOf("Reject") >= 0)
                                {
                                    ((ControlBase)v_ctlModule).CanReject = true;
                                }
                                if (pv_strRightList.IndexOf("Export") >= 0)
                                {
                                    ((ControlBase)v_ctlModule).CanExport = true;
                                }
                            }

                            if (!((ControlBase)v_ctlModule).CanAdd)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnAdd");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
                            ...
                            if (!((ControlBase)v_ctlModule).CanUpdate)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnUpdate");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
                            ...
                            if (!((ControlBase)v_ctlModule).CanDelete)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnDelete");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
                            ...
                            if (!((ControlBase)v_ctlModule).CanApprove)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnApprove");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
                            ...
                            if (!((ControlBase)v_ctlModule).CanUnApprove)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnUnApprove");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
                            ...
                            if (!((ControlBase)v_ctlModule).CanReject)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnReject");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
                            ...
                            if (!((ControlBase)v_ctlModule).CanExport)
                            {
                                Control v_ctl = (Control)v_ctlModule.FindControl("btnExport");
                                if (null != v_ctl)
                                {
                                    v_ctl.Visible = false;
                                }
