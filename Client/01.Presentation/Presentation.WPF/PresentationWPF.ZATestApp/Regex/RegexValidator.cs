...
namespace PresentationWPF.ZATestApp.Regex
{
    ...
    public static class RegexValidator
    {
        ...
        /// <summary> Event fired when input validation fails. </summary>
        public static event EventHandler ValidationFailed;
        /// <summary> Event fired when input validation succeeds, after a previous failure. </summary>
        public static event EventHandler FailureCleared;
        ...
        static RegexValidationRule GetRegexValidationRuleForTextBox(TextBox textBox)
        {
            ...
            if (regexRule == null)
            {
                ...
                regexRule.ValidationFailed += OnValidationFailed;
                regexRule.FailureCleared += OnFailureCleared;
        ...
        static void OnValidationFailed(object sender, EventArgs e)
        {
            if (ValidationFailed != null)
            {
                ValidationFailed(null, new EventArgs());
            }
        }

        static void OnFailureCleared(object sender, EventArgs e)
        {
            if (FailureCleared != null)
            {
                FailureCleared(null, new EventArgs());
            }
        }
