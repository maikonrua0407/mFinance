...
namespace PresentationWPF.ZATestApp.Regex
{
    ...
    public class RegexValidationRule : ValidationRule
    {
        ...
        public event EventHandler FailureCleared;
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (!String.IsNullOrEmpty(this.RegexText))
            {
                ...
                if (!System.Text.RegularExpressions.Regex.IsMatch(text, this.RegexText, this.RegexOptions))
                {
            ...
            if ((result == ValidationResult.ValidResult) && hasValidationFailed)
            {
                hasValidationFailed = false;
                if (FailureCleared != null)
                {
                    FailureCleared(this, new EventArgs());
                }
            }
