...
namespace PresentationWPF.SMS.TinNhanDen
{
    ...
    /// </summary>
    public partial class ucTinNhanDen : UserControl
    {
        #region Khai bao
        ...
        private void Add()
        {
            ...
            ucTinNhanDenKiemTra objThietBiCt = new ucTinNhanDenKiemTra();
            string tittle = DatabaseConstant.layNgonNguTieuDeForm(DatabaseConstant.Function.SMS_DSACH_TNHAN_DEN);
