...
namespace PresentationWPF.SMS.TinNhanDi
{
    ...
    /// <summary>
    /// Interaction logic for ucTinNhanDi.xaml
    /// </summary>
    public partial class ucTinNhanDi : UserControl
    {
        #region Khai bao
        ...
        private void Add()
        {
            ...
            ucTinNhanDiCT objThietBiCt = new ucTinNhanDiCT();
            string tittle = DatabaseConstant.layNgonNguTieuDeForm(DatabaseConstant.Function.SMS_DSACH_TNHAN_DI);
