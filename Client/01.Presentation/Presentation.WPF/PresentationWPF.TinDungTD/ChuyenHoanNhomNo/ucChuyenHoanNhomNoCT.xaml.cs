...
namespace PresentationWPF.TinDungTD.ChuyenHoanNhomNo
{

    public partial class ucChuyenHoanNhomNoCT : UserControl
    {
        ...
        private DatabaseConstant.Function function = DatabaseConstant.Function.TDTD_CHUYEN_HOAN;
        ...
        TDTD_CHUYEN_HOAN_NO obj = null;
        List<TTIN_CHUYEN_HOAN_CHI_TIET> lstChuyenHoan = null;
        ...
        public ucChuyenHoanNhomNoCT(KIEM_SOAT _objKiemSoat)
            : this()
        {
        ...
        private void Release()
        {
            ...
            if (obj != null && obj.ID != null)
            {
                ...
                bool ret = process.UnlockData(DatabaseConstant.Module.TDTD,
                    DatabaseConstant.Function.TDTD_CHUYEN_HOAN,
        ...
        void btnThemKUoc_Click(object sender, RoutedEventArgs e)
        {
            ...
            popupProcess.getPopupInformation("POPUP_DSACH_KUOC_CHUYEN_HOAN_TDTD", lstDieuKien);
            ...
            win.Content = popup;
            win.ShowDialog();
            TTIN_CHUYEN_HOAN_CHI_TIET objTTinCT = null;
            if (lstPopup.Count > 0)
            {
                ...
                foreach (DataRow dr in lstPopup)
                {
                    ...
                    objTTinCT = new TTIN_CHUYEN_HOAN_CHI_TIET();
        ...
        private void SetFormData()
        {
            ...
            try
            {
                ...
                int ret = 0;
                ret = processTinDungTD.ChuyenHoanNhomNo(DatabaseConstant.Action.LOAD_DATA, ref obj, ref listClientResponseDetail);
                if (ret > 0)
                {
        ...
        {
            obj = new TDTD_CHUYEN_HOAN_NO();
            lstChuyenHoan = new List<TTIN_CHUYEN_HOAN_CHI_TIET>();
            ...
            CommonFunction.RefreshButton(Toolbar, DatabaseConstant.Action.THEM, "", mnuMain, DatabaseConstant.Function.TDTD_CHUYEN_HOAN);
        ...
        private bool Validation()
        {
            ...
            try
            {
                ...
                else if (!lstChuyenHoan.Where(f => f.NHOM_NO_CU == f.NHOM_NO_MOI).IsNullOrEmpty() && lstChuyenHoan.Where(f => f.NHOM_NO_CU == f.NHOM_NO_MOI).Count() > 0)
                {
                    if (listClientResponseDetail.IsNullOrEmpty()) listClientResponseDetail = new List<ClientResponseDetail>();
                    foreach (TTIN_CHUYEN_HOAN_CHI_TIET objChuyenNo in lstChuyenHoan.Where(f => f.NHOM_NO_CU == f.NHOM_NO_MOI))
                    {
        ...
        public void OnAddNew()
        {
            ...
            try
            {
                ...
                ret = processTinDungTD.ChuyenHoanNhomNo(DatabaseConstant.Action.THEM, ref obj, ref listClientResponseDetail);
        ...
        public void OnModify()
        {
            ...
            try
            {
                ...
                ret = processTinDungTD.ChuyenHoanNhomNo(DatabaseConstant.Action.SUA, ref obj, ref listClientResponseDetail);
        ...
        public void OnDelete()
        {
            ...
            {
                int ret = 0;
                ret = processTinDungTD.ChuyenHoanNhomNo(action, ref obj, ref listClientResponseDetail);
        ...
        public void OnCalculator()
        {
            ...
            try
            {
                ...
                int ret = 0;
                obj.DSACH_CHUYEN_NO_QHAN = lstChuyenHoan.ToArray();
                ret = processTinDungTD.ChuyenHoanNhomNo(DatabaseConstant.Action.TINH_TOAN_TRICH_LAP_DU_PHONG_CU_THE, ref obj, ref listClientResponseDetail);
                if (ret > 0)
                {
                    lstChuyenHoan = obj.DSACH_CHUYEN_NO_QHAN.ToList();
                    raddgrDSKheUoc.ItemsSource = lstChuyenHoan;
