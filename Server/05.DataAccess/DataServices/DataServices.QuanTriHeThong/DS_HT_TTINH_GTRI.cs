...
{
    public class DS_HT_TTINH_GTRI
    {
        private string ENTITY_SET_NAME = "HT_TTINH_GTRI";

        public bool Them(HT_TTINH_GTRI obj)
        {
            bool kq = true;
            Entities entities = ContextFactory.GetInstance();
            try
            {
                entities.HT_TTINH_GTRI.AddObject(obj);
        ...
        public bool Sua(HT_TTINH_GTRI obj)
        {
            bool kq = true;            
            Entities entities = ContextFactory.GetInstance();
            EntityKey key = null;
        ...
        public bool Xoa(HT_TTINH_GTRI obj)
        {
            bool kq = true;
            Entities entities = ContextFactory.GetInstance();
            try
        ...
        public bool XoaListTheoID(List<int> listID)
        {
            ...
            try
            {
                using (TransactionScope trans = new TransactionScope())
                {
                    ...
                    {
                        HT_TTINH_GTRI obj = new HT_TTINH_GTRI();
                        obj = entities.HT_TTINH_GTRI.FirstOrDefault(e => e.ID == id);
                        entities.DeleteObject(obj);
                        entities.SaveChanges();
                    }
                    trans.Complete();
        ...
        public HT_TTINH_GTRI GetById(int id)
        {
            HT_TTINH_GTRI kq = null;
            Entities entities = ContextFactory.GetInstance();                
            try
            {
                kq = entities.HT_TTINH_GTRI.FirstOrDefault(e => e.ID == id);
                return kq;
            }
            catch (System.Exception ex)
            {
