...
{
    public class DS_HT_PBAN
    {
        private string ENTITY_SET_NAME = "HT_PBAN";

        public bool Them(HT_PBAN obj)
        {
            bool kq = true;
            Entities entities = ContextFactory.GetInstance();
            try
            {
                entities.HT_PBAN.AddObject(obj);
        ...
        public HT_PBAN GetById(int id)
        {
            HT_PBAN kq = null;
            Entities entities = ContextFactory.GetInstance();                
            try
            {
                kq = entities.HT_PBAN.FirstOrDefault(e => e.ID == id);
                return kq;
            }
            catch (System.Exception ex)
            {
