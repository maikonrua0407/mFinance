...
namespace Utilities.Common
{
    ...
    public static class LNumber
    {
        ...
        public static string ReadNumber(this decimal value, LLanguage.Languages language = LLanguage.Languages.Vietnamese, string currency = "VND")
        {
            string result = "";
            string major;
            string minor;
