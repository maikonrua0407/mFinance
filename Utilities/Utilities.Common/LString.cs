...
namespace Utilities.Common
{
    ...
    public static class LString
    {
        ...
        /// <summary>
        /// Tạo chuỗi ký tự ngẫu nhiên có chứa giá trị từ 0 đến Z
        /// </summary>
        /// <param name="length">Độ dài ký tự</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Tạo chuỗi ký tự ngẫu nhiên có chứa giá trị từ một chuỗi truyền vào
        /// </summary>
        /// <param name="chars">Chuỗi giá trị truyền vào</param>
        /// <param name="length">Độ dài ký tự</param>
        /// <returns></returns>
